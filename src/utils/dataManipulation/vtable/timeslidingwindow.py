...
import time
from src.lib.dateutil import parser

### Classic stream iterator
registered = True


class TimeSlidingWindow(src.functions.vtable.vtbase.VT):
...
# def Source():
#     return src.functions.vtable.vtbase.VTGenerator(TimeSlidingWindow)
#
#
# if not ('.' in __name__):
#     """
